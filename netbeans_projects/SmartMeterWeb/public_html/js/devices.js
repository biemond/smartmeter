                ...
                function(event, ui) {
                  ...
                  if ( active !== 0 ) {
                    ...
                    if (data.device[deviceNr].type === 'GAS') {
                        ...
                        showGasOverview(data.device[deviceNr].id,globalUrl,'table_id-'+tabNr,'page-'+tabNr);
                        ...
                        dateField.find("#gasdatepicker").datepicker( {
                           onSelect: function(dateObject) {
                             ...
                             showGasMeasurement(dateObject,globalUrl,'table2_id-'+tabNr,'page-'+tabNr);
                           }
                        });
                        ...
                        // show gas measurement 
                        showGasMeasurement(dateField.find("#gasdatepicker").val(),globalUrl,'table2_id-'+tabNr,'page-'+tabNr);
                    } else if (data.device[deviceNr].type === 'ELEC') { 
                        // show energyoverview
                        console.log('show elec overview id: '+data.device[deviceNr].id + ' page-'+tabNr);
                        showElecOverview(data.device[deviceNr].id,globalUrl,'table_id-'+tabNr,'page-'+tabNr);
                        ...
                        dateField.find("#elecdatepicker").datepicker( {
                           onSelect: function(dateObject) {
                             console.log('datechanged:' + dateObject); 
                             // show gas measurement
                             showElecMeasurement(dateObject,globalUrl,'table2_id-'+tabNr,'page-'+tabNr);
                           }
                        });
                        ...
                        // show gas measurement 
                        showElecMeasurement(dateField.find("#elecdatepicker").val(),globalUrl,'table2_id-'+tabNr,'page-'+tabNr);
